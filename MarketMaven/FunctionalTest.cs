...
namespace MarketMaven
{
    public class FunctionalTest : IDisposable
    {
        ...
        [Test, Order(1)]
        public void Test1_Check_EmployeeLogin_Properties()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            TestBase tb = new TestBase("MarketMaven", "MarketMaven.Models", "EmployeeLogin");
        ...
        [Test, Order(2)]
        public void Test2_Check_EmployeeLogin_DataAnnotations()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
        ...
        [Test, Order(3)]
        public void Test3_Check_Employee_Properties()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            TestBase tb = new TestBase("MarketMaven", "MarketMaven.Models", "Employee");
            var CurrentProperty = new KeyValuePair<string, string>();
        ...
        [Test, Order(4)]
        public void Test4_Check_Employee_DataAnnotations()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            try
            {
                ...
                PropertyUnderTest_attributename = "Required";
                RequiredAttributeTest("Please enter the name");
                ...
                PropertyUnderTest_attributename = "Required";
                RequiredAttributeTest("Please enter the age");

                PropertyUnderTest_propertyname = "Contact";
                PropertyUnderTest_attributename = "Required";
                RequiredAttributeTest("Please enter the contact details");
        ...
        [Test, Order(5)]
        public void Test5_MarketDBContext_DbSet_Property_CreationTest()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            string functionName = NUnit.Framework.TestContext.CurrentContext.Test.Name;
            TestBase tb = new TestBase("MarketMaven", "MarketMaven.Models", "MarketDBContext");
            try
            {
                var IsFound = tb.HasProperty("Employees", "DbSet`1");
                if (!IsFound)
                {
                    msg += tb.Messages.GetPropertyNotFoundMessage("Employees", "DbSet<Employee> \n");
                }
        ...
        [Test, Order(6)]
        [TestCase("RegisterForm", TestName = "Test6_RegisterForm_IsAvailable")]
        [TestCase("AddEmployee", TestName = "Test7_AddEmployee_IsAvailable")]
        [TestCase("GreetNote", TestName = "Test8_GreetNote_IsAvailable")]
        public void Test6_7_8_Get_ActionCreated_Test(string mname)
        {
            ...
            String msg_name = "";
            string functionName = NUnit.Framework.TestContext.CurrentContext.Test.Name;
            TestBase tb = new TestBase("MarketMaven", "MarketMaven.Controllers", "MarketController");
            try
            {
                ...
                if (mname == "GreetNote")
                {
                    Method = tb.type.GetMethod(mname, new Type[] { typeof(EmployeeLogin) });
                }
        ...
        [Test, Order(9)]
        public void Test9_RegisterForm_Post_ActionCreated_Test()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            try
            {
                var Method = tb.type.GetMethod("RegisterForm", new Type[] { typeof(EmployeeLogin) });
                if (Method == null)
                {
            ...
            {
                ExceptionCatch(functionName, $"Exception while check RegisterForm action method is present or not in {tb.type.Name}. \n", msg, msg_name);
            }
        }

        [Test, Order(10)]
        public void Test10_AddEmployee_Post_ActionCreated_Test()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            try
            {
                var Method = tb.type.GetMethod("AddEmployee", new Type[] { typeof(Employee) });
                if (Method == null)
                {
                    msg += $"{tb.type.Name} doesnot defines create action method which accepts over object as parameter \n";
                }
            ...
            {
                ExceptionCatch(functionName, $"Exception while check AddEmployee action method is present or not in {tb.type.Name}. \n", msg, msg_name);
            }
        }

        [Test, Order(11)]
        public void Test11_UI_AddEmployee_Message()
        {
            totalTestcases++;
            String msg = "";
            String msg_name = "";
            ...
            try
            {
                ...
                _driver.Navigate().GoToUrl(appURL + "Market/AddEmployee");
                System.Threading.Thread.Sleep(5000);

                _driver.SetElementText("Email", "test@test.com");
                _driver.SetElementText("Name", "TestName");
                _driver.SetElementText("Password", "test@test.com");
                _driver.SetElementText("ConfirmPassword", "test@test.com");
                _driver.SetElementText("Age", "20");
                _driver.SetElementText("Contact", "8098889990");
                _driver.ClickElement("btnSubmit");
                System.Threading.Thread.Sleep(5000);


                if (!_driver.PageSource.Contains("Email and Password should not be the same"))
                {
                    msg += $"AddEmployee Page NOT displaying the message for Invalid Password correctly.\n";
                }
            ...
            {
                ExceptionCatch(functionName, ex.Message + $"-Exception trying to add and display the employee details. Exception :{ex.InnerException?.Message}\n", msg, msg_name);
            }
        }
        ...
        public void Test12_UI_Test()
        {
            ...
            try
            {
                ...
                _driver.Navigate().GoToUrl(appURL + "Market/RegisterForm");
                System.Threading.Thread.Sleep(5000);
                ...
                _driver.SetElementText("Email", "test@test.com");
                _driver.SetElementText("Name", "TestName");
                _driver.SetElementText("Password", "TestPass");
                _driver.SetElementText("ConfirmPassword", "TestPass");
                _driver.SetElementText("Age", "20");
                _driver.SetElementText("Contact", "8098889990");
                _driver.ClickElement("btnSubmit");
                System.Threading.Thread.Sleep(5000);
                ...
                if (!result.Text.ToString().ToLower().Contains("welcome") || !result.Text.ToString().ToLower().Contains("test@test.com") || !result.Text.ToString().ToLower().Contains("market"))
                {
                    msg += $"GreetNote Page NOT displaying the details correctly.\n";
                }
